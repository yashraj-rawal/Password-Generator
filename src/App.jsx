...
function App() {
  ...
  const generatePassword = useCallback(() => {
    let pass = ""
    let str = "ABCDEFGHIJKLMNOPQURSTUVWXYZabcdefghizijklmnopqurstuvwxyz"
  ...
  return (
    <div className=" max-w-md mx-auto shadow-md rounded-lg px-4 py-4 my-8 bg-gray-800 text-orange-500">
